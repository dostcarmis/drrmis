    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img class="smimg" src="{{ $currentUser->profile_img }}"> 
            ...
            <ul class="dropdown-menu drpinner">
                <div class="col-xs-6 np leftsideinner">
                    <li class="left"><img src="{{ $currentUser->profile_img }}"></li>
                </div>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <li>
            ...
            <ul id="users" class="collapse" aria-expanded="true">
                ...
                <li><a href="{{ action("UserController@viewCreateGroup") }}"><i class="fa fa-object-group"></i> Add User Group</a></li>
