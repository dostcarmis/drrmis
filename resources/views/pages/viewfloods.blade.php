...
<div class="row">
	...
	<div class="col-xs-12">
		...
		<h1 class="page-header">Flood Reports</h1>
		...
		<div class="col-xs-12">
			...
			<div class="col-xs-12 ulpaginations np">
				...
				<div class="col-xs-12 col-sm-8 np">
					...
					<a id="btnadd-location" title="Add Flood" class="btnadd-location btn" href="{{ action('FloodController@viewaddFlood') }}"><span class="glyphicon glyphicon-plus"></span> Add Flood Report</a>
				...
				@foreach($floods as $flood)
					...
					<tr>						
						...
						@if(($currentUser->id == $flood->created_by) || ($currentUser->role_id <= 3))
							...
							<a class="desctitle" href="<?php echo url('editflood'); ?>/<?php echo $flood->id?>">{{ $flood->location }}</a>

						@else

						<a class="desctitle" href="<?php echo url('viewperflood'); ?>/<?php echo $flood->id?>">{{ $flood->location }}</a>
